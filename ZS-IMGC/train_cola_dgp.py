...
from models.cola_dgp import CoLa_DGP
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='CoLa/CD10')
    ...
    gcn = CoLa_DGP(n, edges_set,
                        word_vectors.shape[1], fc_vectors.shape[1], hidden_layers, args.lam).cuda()
